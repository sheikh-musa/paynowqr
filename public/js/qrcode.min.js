...
var QRCode = (function (t) {
  ...
  var v = l,
    p = h(function (t, r) {
      ...
      (r.getRowColCoords = function (t) {
        if (1 === t) return [];
        for (
          var r = Math.floor(t / 7) + 2, n = e(t), o = 145 === n ? 26 : 2 * Math.ceil((n - 13) / (2 * r - 2)), a = [n - 7], i = 1;
          i < r - 1;
          i++
        )
          a[i] = a[i - 1] - o;
    ...
    nt = h(function (t, r) {
      ...
      function i(t, r) {
        ...
        if ((e = K.from(r, n)) !== K.BYTE && e.bit < n.bit)
          throw new Error('"' + t + '" cannot be encoded with mode ' + K.toString(e) + ".\n Suggested mode is: " + K.toString(n));
        ...
        (function (t, r, e) {
          for (var n = "", o = 0, a = !1, i = 0, u = 0; u < t.length; u++) {
            ...
            s || a || (a = !0),
              t[u]
                ? (i++,
                  (u > 0 && s > 0 && t[u - 1]) || ((n += a ? ct("M", s + e, 0.5 + f + e) : ct("m", o, 0)), (o = 0), (a = !1)),
  ...
  function dt(t, r, n, o, a) {
    ...
    2 === u
      ? ((a = n), (n = r), (r = o = void 0))
      : 3 === u && (r.getContext && void 0 === a ? ((a = o), (o = void 0)) : ((a = o), (o = n), (n = r), (r = void 0)));
    try {
      var f = ut(n, o);
      a(null, t(f, r, o));
    } catch (t) {
